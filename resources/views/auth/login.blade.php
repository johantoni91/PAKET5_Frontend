            ...
            <div class="grid md:grid-cols-2 items-center gap-4 max-w-7xl w-full">
                <div
                    ...
                    <form class="space-y-6" action="{{ route('login.process') }}" method="POST">
                        @csrf
                        <div class="mb-10">
                            <h3 class="text-3xl text-center font-extrabold">Sign in</h3>
                            <p class="text-sm text-center mt-4">KARTU PERSONAL</p>
                        </div>
                        <div>
                        ...
                        {{-- <p class="text-sm !mt-10 text-center">Don't have an account <a href="javascript:void(0);"
                                class="text-blue-600 hover:underline ml-1 whitespace-nowrap">Register here</a></p> --}}
                    </form>
                </div>
