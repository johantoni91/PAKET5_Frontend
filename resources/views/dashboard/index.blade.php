...
@section('content')
    <div class = "content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
            ...
            <ol class = "inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class = "flex items-center">
                        ...
                        <a href="#"
                            class = "ml-1 text-sm font-medium text-gray-300 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Home</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="w-full grid grid-4" id="bar"></div>
    </div>
@endsection
